                ...
                <table class="table table-hover mt-3 mb-0">
                    <thead>
                        <tr>
                            ...
                            <th>Name</th>
                            <th>Email</th>
                            <th class="text-nowrap">View Posts</th>
                            <th>Role</th>
                            <th>Time</th>
                            <th>Controls</th>
                        </tr>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo count(countViewerByUser($user['id'])); ?></td>
                                <td><?php echo $roles[$user['role']]; ?></td>
                                <td><?php echo showTime($user['created_at']); ?></td>
                                <td><a href="<?php echo $url; ?>/post_delete.php?id=<?php echo $user['id']; ?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure to delete this post?')">
                                        <i class="feather-trash-2"></i>
                                    </a>

                                    <a href="<?php echo $url; ?>/post_edit.php?id=<?php echo $user['id']; ?>" class="btn btn-outline-warning btn-sm">
