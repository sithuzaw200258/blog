                ...
                <form method="post">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="custom-select required" name="receiver" id="user">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control required" id="amount" name="amount" min="100" max="<?php echo $user['money'] ?>">
                        </div>
                    </div>
